describe("Payments test (with setup and tear-down)",function(){
    ...
    it('should add a new payment to allPayments on submitPayment',function(){
        submitPaymentInfo();
    ...
    it('should not add a new payment to allPayments on submitPaymentInfo() with no bill',function(){
        billAmtInput.value = '';
        submitPaymentInfo();
